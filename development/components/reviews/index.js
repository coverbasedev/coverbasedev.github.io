...
var SELECTORS = {
  SWIPER_PARENT: '[data-role="swiper-parent"]',
  SWIPER_BUTTON_PREV: '[data-role="navigation-button-prev"]',
  SWIPER_BUTTON_NEXT: '[data-role="navigation-button-next"]',
  PAGINATION_BOX: '[data-role="pagination-box"]'
};
...
var styles = ".reviews__list.swiper-wrapper {\n  width: max-content;\n}\n\n.reviews__item.swiper-slide {\n  min-width: auto;\n}";
insertStyles(styles);
var componentElement = document.querySelector('[data-component-id="reviews"]');
var swiperElement = componentElement.querySelector(SELECTORS.SWIPER_PARENT);
var navigationButtonPrevious = componentElement.querySelector(SELECTORS.SWIPER_BUTTON_PREV);
var navigationButtonNext = componentElement.querySelector(SELECTORS.SWIPER_BUTTON_NEXT);
var paginationBox = componentElement.querySelector(SELECTORS.PAGINATION_BOX);
var initSwiper = function initSwiper() {
  ...
  new Swiper({
    ...
    navigation: {
      ...
      prevEl: navigationButtonPrevious
    },
    pagination: {
      el: paginationBox,
      type: 'bullets',
